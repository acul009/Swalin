...
func newOldDeviceView(ep *rpc.RpcEndpoint, device *rpc.DeviceInfo) *oldDeviceView {
...
func (d *oldDeviceView) Prepare() fyne.CanvasObject {
...
func (d *oldDeviceView) CreateRenderer() fyne.WidgetRenderer {
	return &oldDeviceViewRenderer{
		widget: d,
	}
}

type oldDeviceViewRenderer struct {
	widget *oldDeviceView
}

func (d *oldDeviceViewRenderer) Layout(size fyne.Size) {

}

func (d *oldDeviceViewRenderer) MinSize() fyne.Size {
	return fyne.NewSize(0, 0)
}

func (d *oldDeviceViewRenderer) Refresh() {

}

func (d *oldDeviceViewRenderer) Destroy() {

}

func (d *oldDeviceViewRenderer) Objects() []fyne.CanvasObject {
